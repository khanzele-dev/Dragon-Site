  ...
  return (
    <div className="flex items-center justify-between border-b border-white/5 py-3 last:border-none">
      <div>
        ...
        <p className="text-xs text-[#8f7c7a]">{hint}</p>
      </div>
      <span
        className={
          "rounded-full px-3 py-1 text-xs font-medium " +
          (ok ? "bg-emerald-500/10 text-emerald-400" : "bg-white/5 text-[#8f7c7a]")
        }
      >
...
export default function AdminSettingsPage() {
  ...
  return (
    <div>
      ...
      <div className="rounded-xl border border-white/10 bg-gradient-to-br from-[#150d0e] to-[#0d0708] px-5">
        <StatusRow
          label="Remnawave"
